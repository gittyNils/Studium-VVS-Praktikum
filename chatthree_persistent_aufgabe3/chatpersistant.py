...
# Email an mich versenden, wenn /mail aufgerufen wir
class SendMail(webapp.RequestHandler):
     def get(self):
        # App Buch Seite 243
        # mail.send_mail("chat-service@markcc-java-chat.appspot.com", "markcc@gmail.com", "Hi Mark!", "I'm still running")
        mail.send_mail("noreply@nils-schlicher-chatroom-003.appspotmail.com", "Nils.Schlicher@alumni.fh-aachen.de", "Chatroom", 
                    "Hallo Nils, ich laufe noch immer in der Cloud! \nLG nils-schlicher-chatroom-003.appspot.com" )

        self.response.headers["Content-Type"] = "text/html"
        self.response.out.write("""
           <html>
             <head>
               <title>Nils Schlicher's Email-Service </title>
             </head>
             <body>
               <h1>Email wurde versendet!</h1>
             </body>
           </html>""")
